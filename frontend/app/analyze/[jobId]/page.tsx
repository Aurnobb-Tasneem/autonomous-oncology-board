...
function resolveAgent(step: SseStep): string {
  ...
  if (type.includes("patholog")) return "pathologist";
  if (type.includes("research")) return "researcher";
  if (type.includes("oncolog")) return "oncologist";
  if (type.includes("debate") || type.includes("challenge") || type.includes("revise")) return "debate";
  return "system";
}
...
export default function AnalyzePage() {
  ...
  const progress = Math.min(Math.round((steps.length / totalExpected) * 100), status === "done" ? 100 : 95);
