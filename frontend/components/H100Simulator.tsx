...
const COMPONENTS: Component[] = [
  ...
  { id: "lora_suite", label: "LoRA Suite ×3", gb: 22, color: "#38bdf8", required: false, description: "Llama 3.1 8B base + TNM/Biomarker/Treatment adapters via vLLM (~22 GB)" },
  { id: "kv_cache", label: "KV Cache (debate ctx)", gb: 20, color: "#7c3aed", required: false, description: "Transformer attention key-value cache across full debate context" },
